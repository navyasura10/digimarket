...
import products from "./ProductData"; // ✅ we'll create this file next
      ...
      <div>
        ...
        <div className="flex gap-4">
          ...
          <button
            ...
            className="border border-gray-400 px-4 py-2 rounded-md hover:bg-gray-100 flex items-center gap-2"
          >
